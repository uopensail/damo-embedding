...
class PyEmbeddingFactory(object):
    ...
    def __init__(self, *args):
        _damo.PyEmbeddingFactory_swiginit(self, _damo.new_PyEmbeddingFactory(*args))
    __swig_destroy__ = _damo.delete_PyEmbeddingFactory

    def dump(self, path, expires):
        return _damo.PyEmbeddingFactory_dump(self, path, expires)

# Register PyEmbeddingFactory in _damo:
_damo.PyEmbeddingFactory_swigregister(PyEmbeddingFactory)
