...
class PyEmbeddingFactory(object):
    ...
    def __init__(self, max_lag, data_dir, filter, optimizer, initializer):
        _pyEmbedding.PyEmbeddingFactory_swiginit(self, _pyEmbedding.new_PyEmbeddingFactory(max_lag, data_dir, filter, optimizer, initializer))
